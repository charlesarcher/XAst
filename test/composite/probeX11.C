...
int main(int argc, char** argv)
 {if (argc!=2)
  ...
  XColor hottest={0,65535,65535,65535,DoRed|DoGreen|DoBlue,0},
         hotter={0,65535,65535,0,DoRed|DoGreen|DoBlue,0},
         hot={0,65535,42405,0,DoRed|DoGreen|DoBlue,0};
  ...
  {CompositePixmap f0(display,drawable,explosionEdge_width,explosionEdge_height);
  ...
  {CompositePixmap f1(display,drawable,explosionEdge_width,explosionEdge_height);
  ...
  {CompositePixmap f2(display,drawable,explosionEdge_width,explosionEdge_height);
  ...
  {CompositePixmap f3(display,drawable,explosionEdge_width,explosionEdge_height);
  ...
  {CompositePixmap f4(display,drawable,explosionEdge_width,explosionEdge_height);
