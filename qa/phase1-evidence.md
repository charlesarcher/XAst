...
3. **x11types.H shim consumers** — 20 files: AutoRepeatOn.C, options.H, button.H, stage.H, playingField.H, shipYard.H, enemyBulletGroup.H, enemyGroup.H, explosion.H, explosionGraphic.H, rockGroup.H, shipBulletGroup.H, shipGroup.H, movableObject.H, bullet.H, frameList.H, compositePixmap.H, rotatorDisplayData.{H,C}, rotator.H. **Shim deletion: task 47.**
